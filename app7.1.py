...
def main():
    ...
    st.write("I am JSON, here to help you craft compelling messages for UK's job applications, from resumes to cover letters and LinkedIn connections.")
    ...
    if state.resume_input_method == "Upload Context":
        ...
        state.resume_text = st.sidebar.text_area("Share more about yourself:", placeholder="Completely optional, feel free to skip this.....", height=200)
